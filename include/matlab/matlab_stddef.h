...
#ifndef _MATLAB_STDDEF_H_
#define _MATLAB_STDDEF_H_
...
#define MATLAB_VERSION_MAJOR           1
#define MATLAB_VERSION_MINOR           0

// Engineering-focused interface version
#define MATLAB_INTERFACE_VERSION       6000
#define MATLAB_INTERFACE_VERSION_MAJOR (MATLAB_INTERFACE_VERSION/1000)

// The oldest major interface version still supported
// To be used in SONAME, manifests, etc.
#define MATLAB_COMPATIBLE_INTERFACE_VERSION    2
...
#       define __MATLAB_x86_64 1
#   elif defined(_M_IA64)
#       define __MATLAB_ipf 1
#   elif defined(_M_IX86)||defined(__i386__) // the latter for MinGW support
#       define __MATLAB_x86_32 1
#   endif
#else /* Assume generic Unix */
#   if !__linux__ && !__APPLE__
#       define __MATLAB_generic_os 1
#   endif
#   if __x86_64__
#       define __MATLAB_x86_64 1
#   elif __ia64__
...
#       define __MATLAB_x86_32 1
#   else
#       define __MATLAB_generic_arch 1
#   endif
#endif
...
#include "matlab_config.h"
    ...
    #define __MATLAB_EXPORTED_METHOD
#endif
 ...
 * So it can be different than the value of MATLAB_INTERFACE_VERSION obtained at compile time.
 */
//extern "C" int __MATLAB_EXPORTED_FUNC MATLAB_runtime_interface_version();
...
#define __MATLAB_atomic // intentionally empty, see above
...
#define __MATLAB_offsetof(class_name, member_name) \
    ((ptrdiff_t)&(reinterpret_cast<class_name*>(0x1000)->member_name) - 0x1000)

//! Returns address of the object containing a member with the given name and address
#define __MATLAB_get_object_ref(class_name, member_name, member_addr) \
    (*reinterpret_cast<class_name*>((char*)member_addr - __MATLAB_offsetof(class_name, member_name)))
