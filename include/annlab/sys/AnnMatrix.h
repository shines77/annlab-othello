...
public:
	...
	bool init_matrix(const TCHAR *szName, int _rows, int _cols,
        int _initMode = INIT_MODE_NONE,
		int _initFcn = MAT_INIT_DEFAULT,
        double _fillVal = 0.0);
	bool init_data  (int _rows, int _cols,
        int _initFcn = MAT_INIT_DEFAULT,
        double _fillVal = 0.0);
	bool copy_data  (double *pNewData, int _rows, int _cols,
        int _initFcn = MAT_INIT_DEFAULT,
        double _fillVal = 0.0);
	...
	bool create   (int _rows, int _cols,
        int _initFcn = MAT_INIT_DEFAULT,
        double _fillVal = 0.0);
	bool create_ex(const TCHAR *szName, int _rows, int _cols,
        int _initFcn = MAT_INIT_DEFAULT,
        double _fillVal = 0.0);
	...
	void clear (void);
	int  resize(int _initFcn, double _fillVal = 0.0);
    ...
    CAnnMatrix _order  (int _rows, int _cols, int _order = 0) const;
